...
export default function Home() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 font-[family-name:var(--font-montserrat)] text-sm tracking-wide">
              <a href="#home" className="text-[var(--foreground)] hover:text-[var(--accent-burgundy)] transition-colors">
                Home
              </a>
              <a href="#products" className="text-[var(--foreground)] hover:text-[var(--accent-burgundy)] transition-colors">
                Products
              </a>
              <a href="#about" className="text-[var(--foreground)] hover:text-[var(--accent-burgundy)] transition-colors">
                About
              </a>
              <a href="#contact" className="text-[var(--foreground)] hover:text-[var(--accent-burgundy)] transition-colors">
                Contact
              </a>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section id="home" className="relative min-h-screen hero-gradient bg-pattern flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
          ...
          <h1 className="font-[family-name:var(--font-cormorant)] text-6xl md:text-8xl font-bold mb-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s', animationFillMode: 'forwards' }}>
            <span className="gradient-text">Swee 2+</span>
          </h1>
          
          <p className="font-[family-name:var(--font-cormorant)] text-2xl md:text-3xl text-[var(--accent-burgundy)] mb-4 animate-fade-in-up opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            Redefining Beauty Standards
          </p>
          
          <p className="max-w-2xl mx-auto text-lg text-gray-600 mb-12 animate-fade-in-up opacity-0 leading-relaxed" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            Experience the future of cosmetics. Premium formulations crafted with care, 
            designed to enhance your natural beauty and empower your confidence.
          </p>
          ...
          <div className="mt-16 animate-fade-in-up opacity-0" style={{ animationDelay: '1.2s', animationFillMode: 'forwards' }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="max-w-2xl mx-auto text-gray-600 text-lg">
              From everyday essentials to glamorous must-haves, discover our complete range of premium cosmetics crafted for every occasion.
            </p>
          </div>
      ...
      {/* About Section */}
      <section id="about" className="py-24 px-6 bg-[var(--background)] bg-pattern">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                Swee 2+ is a premium cosmetics brand born from a passion for beauty and self-expression. 
                As a proud sub-brand of Mr SHAH and COMPANYES, we bring decades of expertise in 
                quality and innovation to the beauty industry.
              </p>
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                Our mission is to create cosmetics that not only enhance your natural beauty but also 
                nourish and care for your skin. Every product is crafted with premium ingredients 
                and designed to make you feel confident and beautiful.
              </p>
              
              <div className="flex items-center gap-6">
                <div className="text-center">
                  <div className="font-[family-name:var(--font-cormorant)] text-4xl font-bold text-[var(--accent-burgundy)]">50+</div>
                  <div className="text-sm text-gray-500">Products</div>
                </div>
                <div className="w-px h-12 bg-[var(--accent-rose)]"></div>
                <div className="text-center">
                  <div className="font-[family-name:var(--font-cormorant)] text-4xl font-bold text-[var(--accent-burgundy)]">100%</div>
                  <div className="text-sm text-gray-500">Premium Quality</div>
                </div>
                <div className="w-px h-12 bg-[var(--accent-rose)]"></div>
                <div className="text-center">
                  <div className="font-[family-name:var(--font-cormorant)] text-4xl font-bold text-[var(--accent-burgundy)]">2026</div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { icon: "🌿", title: "Premium Ingredients", desc: "Carefully sourced, skin-loving formulas" },
              { icon: "🔬", title: "Dermatologically Tested", desc: "Safe for all skin types" },
      ...
      <footer id="contact" className="bg-[var(--foreground)] text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Elevating beauty standards with premium cosmetics. 
                Launching in 2026 with a complete range of skincare and makeup products.
              </p>
            </div>

            {/* Quick Links */}
            <div>
              <h4 className="font-[family-name:var(--font-cormorant)] text-xl font-semibold mb-6">Quick Links</h4>
              <ul className="space-y-3">
                <li><a href="#home" className="text-gray-400 hover:text-[var(--accent-gold)] transition-colors">Home</a></li>
                <li><a href="#products" className="text-gray-400 hover:text-[var(--accent-gold)] transition-colors">Products</a></li>
                <li><a href="#about" className="text-gray-400 hover:text-[var(--accent-gold)] transition-colors">About Us</a></li>
                <li><a href="#contact" className="text-gray-400 hover:text-[var(--accent-gold)] transition-colors">Contact</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="text-gray-400 leading-relaxed">
                <p className="font-semibold text-[var(--accent-gold)] mb-2">Mr SHAH and COMPANYES</p>
          ...
          <div className="border-t border-gray-800 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              ...
              <div className="flex gap-6">
                <a href="#" className="text-gray-500 hover:text-[var(--accent-gold)] transition-colors text-sm">
                  Privacy Policy
                </a>
                <a href="#" className="text-gray-500 hover:text-[var(--accent-gold)] transition-colors text-sm">
                  Terms of Service
